...
from config import OLLAMA_DEFAULT_MODEL, ROUTE_CLASSIFY_NUM_PREDICT, ROUTE_CLASSIFY_TIMEOUT
from tools.ollama_client import OllamaClient


class TextAttachmentRouteResolver:
    def __init__(self) -> None:
        self.client = OllamaClient(timeout=ROUTE_CLASSIFY_TIMEOUT, num_predict=ROUTE_CLASSIFY_NUM_PREDICT)
