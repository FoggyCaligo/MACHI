# MK2 프로젝트의 방향성 / 철학 / 규정 / 장기 유지 원칙

이 문서는 MK2에서 앞으로도 유지되어야 하고, 쉽게 바뀌지 않을 핵심 방향과 철학만 정리한 문서다.
...
MACHI 전체 맥락에서 보면, MK2는 독립된 챗봇 프로젝트가 아니라
**개인 전용 Cognitive Partner / 개인 인지 시스템 비전에서 memory substrate를 구현하는 현재 작업 축**이다.

즉 MK2는:
- IDEA1의 Cognitive Partner / 구조 학습 / 자아-세계-기억 분리 문제의식
- MK1의 운영 규칙 / 승인 / 거버넌스 문제의식
- MK2의 local agent / trusted search / light memory 프로토타입
