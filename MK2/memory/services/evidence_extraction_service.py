...
from config import EVIDENCE_EXTRACT_TIMEOUT, EXTRACT_NUM_PREDICT, EXTRACT_RETRY_NUM_PREDICT
...
class EvidenceExtractionService:
    def __init__(
        self,
        timeout: int = EVIDENCE_EXTRACT_TIMEOUT,
        num_predict: int = EXTRACT_NUM_PREDICT,
        retry_num_predict: int = EXTRACT_RETRY_NUM_PREDICT,
    ) -> None:
