...
TOPIC_ROUTER_NUM_PREDICT = 96
TOPIC_CREATE_MIN_CONFIDENCE = 0.55
TOPIC_CONFIRM_MIN_CONFIDENCE = 0.75


GENERAL_REPLY_TIMEOUT = 240
GENERAL_REPLY_NUM_PREDICT = 1800
GENERAL_REPLY_MAX_CONTINUATIONS = 3

ATTACHMENT_REPLY_TIMEOUT = 180
ATTACHMENT_REPLY_NUM_PREDICT = 700
ATTACHMENT_REPLY_MAX_CONTINUATIONS = 2

PROJECT_REPLY_TIMEOUT = 180
PROJECT_REPLY_NUM_PREDICT = 900
PROJECT_REPLY_MAX_CONTINUATIONS = 2
