...
Memory:
memory_summary is only a small automatically recalled subset of persistent memory, not the full store. When talking about a theme related with past or memory, remind past memories with graph_search tool. also, you can query a returned node_id. Don't treat prior assistant utterances as fixed facts.
