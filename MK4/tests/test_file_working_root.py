...
@pytest.mark.asyncio
async def test_dot_or_missing_search_root_uses_working_root() -> None:
    registry = ToolRegistry()
...
@pytest.mark.asyncio
async def test_document_and_image_tools_share_working_root() -> None:
    registry = ToolRegistry()
    ...
    try:
        ...
        assert document_call.arguments["path"] == "MK4/docs/a.pdf"
        assert image_call.arguments["path"] == "MK4/assets/a.png"
    finally:
        reset_file_working_root(token)
