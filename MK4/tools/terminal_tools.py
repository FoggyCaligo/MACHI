        ...
        registry.register(
            ToolDefinition(
                ...
                description=(
                    ...
                    "instead of guessing paths. Commands may intentionally modify locations outside the workspace; when they do, "
                    "verify the resulting external state explicitly because filesystem_changed only reflects the workspace snapshot."
                ),
                input_schema={
                    "type": "object",
                    "properties": {
