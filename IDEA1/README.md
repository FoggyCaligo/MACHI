...
IDEA1은 MACHI의 가장 초기 단계로, **Cognitive Partner 개념**과 **인지 구조 자체를 어떻게 설계할 것인가**를 탐색하던 버전입니다.
...
즉, IDEA1은 "좋은 챗봇을 만들자"보다 **"어떤 인지 시스템을 만들 것인가"** 를 먼저 묻는 단계입니다.
...
실제 구현이 가장 진전된 현재 축은 `MK2`이지만, MACHI가 왜 지금 방향을 갖게 되었는지는 IDEA1 문서들을 보면 가장 잘 드러납니다.
