        ...
        with uow_factory() as uow:
            ...
            node_a = uow.nodes.add(
                Node(
                    ...
                    raw_value='MK3',
                    normalized_value='MK3',
                    payload={'source_counts': {'user': 2}, 'raw_aliases': ['MK3'], 'source': 'token_rule', 'address_scope': 'token_rule'},
                    trust_score=0.82,
            ...
            node_b = uow.nodes.add(
                Node(
                    ...
                    raw_value='MK3',
                    normalized_value='MK3',
                    payload={'source_counts': {'search': 1}, 'source': 'token_rule', 'address_scope': 'token_rule'},
                    trust_score=0.65,
