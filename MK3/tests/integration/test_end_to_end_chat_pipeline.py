...
class FakeVerbalizer(Verbalizer):
    def verbalize(self, conclusion: CoreConclusion, *, model_name: str = 'MK3-graph-core') -> VerbalizationResult:
        return VerbalizationResult(
            ...
            used_llm=(model_name != 'MK3-graph-core'),
            llm_error=None,
        )
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert response['used_model'] == 'MK3-graph-core'
