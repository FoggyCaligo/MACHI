...
좀 뜬금없긴 한데, 글록의 특징과, 총기시장에서의 의의에 대해 말해줄래?

현재 루트에서 한 단계 더 위로 올라가면 playlist2 폴더가 있을 거거든? 그 폴더 안에는 pli_file이라는 폴더가 있을 거고. 그 pli_file안의 tag.txt 파일에, 맨 마지막 줄에 감성, 샤워 이렇게 2개의 태그를 한 줄로 추가해줄래?