...
2. contradiction/revision 규칙을 `edge_family + connect_type + 상태값` 기준으로 명확화
3. identity/topic continuity 회귀 테스트 세트 확장

## P1
1. connect_type 승격 정책 고도화
   - per-connect-type threshold, 세션/전역 근거 분리, 승격 롤백 정책
...
## 참고
- 단기 실행 목록은 [현재작업.txt](/c:/Users/bigla/Documents/git/MACHI/MK3/docs/todo/현재작업.txt)에서 관리한다.
