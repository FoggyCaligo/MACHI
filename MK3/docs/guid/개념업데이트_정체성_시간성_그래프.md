...
이유는 MK3가 세계를 "개념 분화"의 연속으로 이해하기 때문이다.
...
이 방식은 이미 MK3가 가지고 있는 `graph_event`, trust 변화, revision, assistant ingest, message metadata 흐름과도 자연스럽게 연결된다.
