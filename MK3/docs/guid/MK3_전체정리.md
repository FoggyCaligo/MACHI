...
IDEA1 원설계의 "노드 = 체감된 개념" 철학이 MK3에서 미구현으로 남았다.
...
MK3는 여기서 마무리한다. 이후 작업은 MK4에서 진행된다.

## 11. 문서 체계
- 마스터: `docs/guid/MK3_전체정리.md`
- 아키텍처 상세: `docs/architecture/*`
- 전략: `docs/guid/MK3_검색_및_검증_전략.md`
- 핸드오프: `docs/handoff/MK3_handoff.md`
