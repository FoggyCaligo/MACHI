...
When the user explicitly requests a tool action, return final_answer_kind="tool_completion" and name every required successful tool in completion_tools. If it failed, retry or return blocked; do not present an unsupported answer as completion.
"""
