...
- File reads/edits: if a target file/path is known, read it first unless tool_history already contains its needed content. Use file_read for UTF-8 text and document_read for PDF/DOCX. Then either answer from the content or perform the requested change. Do not stop after file_read/document_read with neither final_answer nor tool_calls.
