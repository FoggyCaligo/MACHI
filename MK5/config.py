...
QUESTION_SLOT_PLANNER_TIMEOUT_SECONDS = _env_float('QUESTION_SLOT_PLANNER_TIMEOUT_SECONDS', 40.0)
...
SEARCH_SCOPE_GATE_TIMEOUT_SECONDS = _env_float('SEARCH_SCOPE_GATE_TIMEOUT_SECONDS', 35.0)
SEARCH_SCOPE_GATE_TEMPERATURE = _env_float('SEARCH_SCOPE_GATE_TEMPERATURE', 0.0)
SEARCH_SCOPE_GATE_NUM_PREDICT = _env_optional_int('SEARCH_SCOPE_GATE_NUM_PREDICT')
...
MEANING_ANALYZER_TIMEOUT_SECONDS = _env_float('MEANING_ANALYZER_TIMEOUT_SECONDS', 45.0)
MEANING_ANALYZER_TEMPERATURE = _env_float('MEANING_ANALYZER_TEMPERATURE', 0.0)
MEANING_ANALYZER_NUM_PREDICT = _env_optional_int('MEANING_ANALYZER_NUM_PREDICT')

VERBALIZER_OLLAMA_TIMEOUT_SECONDS = _env_float('OLLAMA_VERBALIZER_TIMEOUT_SECONDS', 240.0)
...
SEARCH_BACKEND_TIMEOUT_SECONDS = _env_float('SEARCH_BACKEND_TIMEOUT_SECONDS', 8.0)
