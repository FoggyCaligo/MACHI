...
from MK6_1.core.entities.translated_graph import ConceptPointer, LocalSubgraph, TranslatedGraph
from MK6_1.core.thinking.claim_graph import (
    AssertionState,
    ClaimAssertion,
...
from MK6_1.core.utils.hash_resolver import ANCHOR_ASSISTANT, ANCHOR_USER, compute_hash
